...
export function MenuLateral() {
  ...
  const handleSignOut = () =>{
  destroyCookie(undefined, "admin_logado_id")
  destroyCookie(undefined, "admin_logado_nome")
  destroyCookie(undefined, "admin_logado_token")
  router.push("/")
  }
  return (
